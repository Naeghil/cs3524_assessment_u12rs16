...
public class MUD {
    ...
    /** Public stuff. 
	 *  These methods are designed to hide the internal structure
     *  of the MUD. Could declare these on an interface and have
     *  external objects interact with the MUD via the interface. */
    // Constructor
    ...
    // A main method used to test that the MUD is specified correctly.
